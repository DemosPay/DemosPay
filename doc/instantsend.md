...
This mechanism has been integrated into Bitcore-Node-Demos which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/demospay/insight-api-demos#web-socket-api](https://github.com/demospay/insight-api-demos#web-socket-api)
* API: [https://github.com/demospay/insight-api-demos#instantsend-transactions](https://github.com/demospay/insight-api-demos#instantsend-transactions)
...
By default, the Demos Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Demos Core daemon:
