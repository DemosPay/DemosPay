...
Only requiring some minor changes is demos.cpp.
...
Changes to demos.cpp
----------------------
demos.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
