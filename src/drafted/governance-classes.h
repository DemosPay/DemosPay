 ...
 *
 *   // network
 *   CDemosNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.demos.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CDemosNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: DemosNetwork
// //   -- signature requirements : Key1(User)
// class CDemosNetworkVariable : public CGovernanceObject
// {
// private:
