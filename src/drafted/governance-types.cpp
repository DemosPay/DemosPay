...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "DemosNetwork") type = DemosNetwork;
    if(strType == "DemosNetworkVariable") type = DemosNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == DemosNetwork) s = "DemosNetwork";
    if(type == DemosNetworkVariable) s = "DemosNetworkVariable";
