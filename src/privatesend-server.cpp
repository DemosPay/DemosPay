...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all Demos related functionality
...
/*
    ...
    allow endless transaction that would bloat Demos and make it unusable. To
