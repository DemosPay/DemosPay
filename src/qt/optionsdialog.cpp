    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("DEMOS-light"), QVariant("light"));
    ui->theme->addItem(QString("DEMOS-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("DEMOS-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("DEMOS-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("DEMOS-traditional"), QVariant("trad"));
