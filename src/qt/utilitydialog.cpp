    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Demos Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Demos Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  demos-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Demos in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 DEMOS, 0.1 DEMOS, 1 DEMOS and 10 DEMOS -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://demospay.atlassian.net/wiki/display/DOC/PrivateSend\">https://demospay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Demos Core is shutting down...") + "<br /><br />" +
